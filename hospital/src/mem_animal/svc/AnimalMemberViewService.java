...
public class AnimalMemberViewService {
	...
	public ArrayList<mem_Animal> getMember(String viewId) {
		...
		ArrayList<mem_Animal> list = mem_animalDAO.selectAnimalMember(viewId); // MemberDAO 클래스에 정의되어있는 selectMember 메서드를 호출하여 인자로 지정된 아이디를
