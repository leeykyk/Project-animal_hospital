		...
		<form action="doctorModifyAction.doc" name="modform" method="post">
			...
			<table class="table1" align="center">
				<tr>
					...
					<td><button type="button" class="btn btn-outline-info btn-lg"><a href="${pageContext.request.contextPath }/doctorDeleteAction.doc?id=${doctor.doctor_ID }" style="color:skyblue">탈퇴</a></button></td>		
				</tr>
			</table>
			<br>		
		</form>
